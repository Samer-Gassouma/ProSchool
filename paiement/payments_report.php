            ...
            <div class="col-md-12">
                <table class="table table-bordered" id='report-list'>
                    ...
                    <tbody>
                      ...
                      $i = 1;
                      $total = 0;
                      $payments = $conn->query("SELECT p.*,s.full_name as sname, ef.ef_no,s.id FROM payments p inner join student_ef_list ef on ef.id = p.ef_id inner join student s on s.id = ef.student_id where date_format(p.date_created,'%Y-%m') = '$month' order by unix_timestamp(p.date_created) asc ");
			          ...
			          <tr>
                        ...
                        <td>
                            <p> <b><?php echo date("M d,Y H:i A",strtotime($row['id'])) ?></b></p>
                        </td>
                        <td>
