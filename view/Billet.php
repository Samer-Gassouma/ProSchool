...
<?php }} ?>
                  	...
                  	<div class="box-footer">
						<input type="hidden" name="my_school" id="my_school" value="<?php echo $my_school; ?>">
...
//MSK-000109	
	...
	var my_school = document.getElementById("my_school").value;
    ...
    xhttp.open("GET", "Billet_wise.php?grade="+grade + "&my_school="+my_school , true);												
...
//MSK-000125
	...
	var xhttp = new XMLHttpRequest();//MSK-000126-Ajax Start
    	...
    	xhttp.open("GET", "Billet_wise.php?grade="+grade , true);												
	...
	var xhttp = new XMLHttpRequest();//MSK-00149-Start Ajax  
  		xhttp.onreadystatechange = function() {
    		if (this.readyState == 4 && this.status == 200) {
				...
				document.getElementById("address2").innerHTML =myArray1[2];
				document.getElementById("gender2").innerHTML =myArray1[3];
				document.getElementById("phone2").innerHTML =myArray1[4];
				document.getElementById("email2").innerHTML =myArray1[5];
				document.getElementById("photo2").src ="../"+myArray1[6];
...
$grade=$_GET['class'];
	...
	if($msg==1){
		...
		echo '<script>','printINV('.$index.','.$invoice_number.','.$desc.');','</script>';
