                  		...
                  		<div class="form-group" id="divGender">
                    		...
                    		<div class="col-xs-4" id="divGender1">
                    			<select name="grade" class="form-control" id="grade" >
									...
									$sql="SELECT name FROM class,subject_routing WHERE  subject_routing.teacher_id='$id' and class.id = subject_routing.class_id and subject_routing.Id_School = '$Id_School'";
...
<?php }} ?>
                  	...
                  	<div class="box-footer">
                    	<button type="button" class="btn btn-primary"  onClick="showStudentTable(this)">Submit</button>
                  	</div>
              	</div>
            </div>
		</div>
  		...
  		<div class="modal-dialog">
    		<div class="modal-content">
				...
				<div class="modal-body bgColorWhite">
      			...
      			<div class="modal-footer">
					<a href="#" style='margin-left:10px;' id="btnYes1" class="deletebtn btn btn-danger col-sm-2 pull-right">Yes</a>
        			<button type="button" class="btn btn-primary col-sm-2 pull-right" data-dismiss="modal" id="frm_cancel">No</button>
      			</div>
    		</div>
  		</div>
