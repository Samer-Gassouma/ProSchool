...
$sql="select * from student_attendance where index_number='$id' and year='$current_year' and Id_school = '$my_school' ORDER BY date DESC,time DESC";
...
<?php } ?>
                            ...
                            <div style="float:left; width:100px; ">
                                    ...
                                    <div style="background-color:#00FF66; width:15px; height:15p	x; float:left; margin-right:2px;"> </div> <span style="text-align:left;">  - Present </span><br> 
