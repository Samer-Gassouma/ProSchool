...
<?php }} ?>
					...
					<input type="hidden" id="my_school" value="<?php echo $my_school; ?>">
	...
	<inpuy type="hidden" id="my_school" value="<?php echo $my_school; ?>">
...
//MSK-000109
	...
	var xhttp = new XMLHttpRequest();//MSK-000110-Start Ajax  
    	...
    	xhttp.open("GET", "timetable_grade_wise.php?grade="+grade + "&do="+do1 + "&my_school="+my_school , true);												
    		...
    		if (this.readyState == 4 && this.status == 200) {	
				...
				$("#subject").change(function() {//MSK-000120
					...
					var xhttp1 = new XMLHttpRequest();//MSK-00121-Ajax Start  
    					...
    					xhttp1.open("GET", "../model/get_teacher_timetable.php?subject="+subject + "&grade="+Id + "&my_school="+my_school, true);												
	...
	var xhttp = new XMLHttpRequest();
		xhttp.onreadystatechange = function() {
    		...
    		if (this.readyState == 4 && this.status == 200) {	
				...
				document.getElementById("day").value=myArray[2];
...
//MSK-000143-6-PHP-JS-INSERT
	...
	if($msg==6){
		...
		echo"
			...
			var myModal = $('#class_room_inserted');
			myModal.modal('show');
