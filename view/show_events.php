...
<div class="modal msk-fade" id="modalviewEvent" tabindex="-1" role="dialog" aria-labelledby="insert_alert1" aria-hidden="true" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog">
		<div class="container col-lg-6 modal-content1">
      		<div class="row">
          		<div class="panel">
                	...
                	<div class="panel-footer">
                        ...
                        <span class="pull-right">
                            <a href="#" onClick="showUEventmodal('<?php echo $event_id; ?>')"   type="button" class="btn btn-sm btn-warning"><i class="glyphicon glyphicon-edit"></i></a>
                            <a href="#" type="button" onClick="deleteEvent('<?php echo $event_id; ?>')" class=" btn btn-sm btn-danger" ><i class="glyphicon glyphicon-remove"></i></a>
                        </span>
                    </div>
            	</div>
			</div>
