...
$sql="select student.full_name as std_name,student.id as std_id,student.index_number as std_index,student.Id_School as std_school
      from student
	  where student.class_id='$grade_id' and student._status=''";
...
?>   
          			<tr>
                    	...
                    	<td> 
<?php
$sql3="SELECT * FROM student_exam WHERE index_number='$std_index'";
...
<a href="#" class=" btn btn-primary btn-xs" onClick="showModalViewExam('.$exam_id.','.$year.','.$std_index.')"  >View Exam Marks</a>';
	...
	echo'<a href="#" class=" btn btn-warning btn-xs" onClick="showModalAddExam('.$exam_id.','.$std_index.','.$grade_id.','.$Id_School.')"  >Add Exam Marks</a>';
}
?>
