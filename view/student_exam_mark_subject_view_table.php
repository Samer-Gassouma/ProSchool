...
?>			
		<tr id="tr_<?php echo $count; ?>">
            ...
            <td id="action_<?php echo $count; ?>">
            	<a href="#" id="edit_exam_mark_<?php echo $count; ?>" onClick="editExamMark('<?php echo $row1['ex_id']; ?>','<?php echo $count; ?>')" data-id="<?php echo $row['id']; ?>,<?php echo $count; ?>" class="label-warning "><span class="glyphicon glyphicon-edit "></span></a>
            </td>
        </tr>
