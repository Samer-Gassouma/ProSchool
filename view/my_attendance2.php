...
$status5="";
$date_no2="";
$sql="select * from teacher_attendance where index_number='$index'  and year='$current_year' and month='$current_month'";
...
?>   
                                    	<tr>
											...
											<td id="td_month_<?php echo $count; ?>"><?php echo $current_month; ?></td>
											<td id="td_year_<?php echo $count; ?>"><?php echo $current_year; ?></td>
											<td id="td_status_<?php echo $count; ?>"><?php echo $status; ?></td>
										</tr>
                                    	</tr>
<?php } ?>
                        			</tbody>
