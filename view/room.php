              	...
              	<div class="box box-primary">
                	...
                	<form role="form" action="../index.php" method="post">             
						<div class="box-body">
							...
							<input type="hidden" name="id_shcool" value="<?php echo $my_school; ?>">
                		</div>
        	...
        	<div class="col-md-8">
            	<div class="box">
                	<div class="box-header">
                  		<h3 class="box-title">All Class Room</h3>
                	</div>
...
<?php }  ?>
    ...
    <form action="../model/update_room.php" method="POST">
...
//MSK-00104
    ...
    xhttp.open("GET", "../model/get_room.php?id=" + Id , true);												
...
function Updateclassroom(){
	...
	if(name1 == ''){
		...
		var url = "../model/update_classroom.php?id=" +Id1 + "&name="+name1  + "&do="+do1;
		window.location=url;
		var xhttp = new XMLHttpRequest();//MSK-00111-Ajax Start  
  			xhttp.onreadystatechange = function() {
				if (this.readyState == 4 && this.status == 200) {
					...
					if(msg==1){//MSK-000113
						...
						document.getElementById("td2_"+ name ).innerHTML =myArray2[2];
  			...
  			xhttp.open("GET", "../model/update_classroom.php?id=" + Id1 + "&name="+name1  + "&do="+do1, true);												
	...
	<div class="modal msk-fade " id="deleteConfirm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  		<div class="modal-dialog">
    		<div class="modal-content">
				...
				<?php
				  echo ' <a href="../model/deletes.php?id='.$id.'"  style="margin-left:10px;" class="deletebtn btn btn-danger col-sm-2 pull-right">Yes</a>'; ?>
