                  	...
                  	<div class="box-body">
                        <div class="form-group" id="divYear">
                        	...
                        	<div class="col-md-7" id="divYear1">
                                <select name="year" class="form-control" id="year" style="width:105%;" >
...
<?php }} ?>
                        ...
                        <br><br>
                         <div class="form-group " id="divMonth">
                        	...
                        	<div class="col-md-7" id="divMonth1">
                                <select name="month" class="form-control " id="month" style="width:105%;">
                  	...
                  	<div class="box-footer">
                    	<button type="button" id="btnSubmit" class="btn btn-primary"  onClick="showTeacher(this)">Submit</button>
                  	</div>
            	</div>
        	</div>
    	</div>
...
//MSK-000109
	...
	if(year == 'Select Year' || month == 'Select Month' ){
		...
		var xhttp = new XMLHttpRequest();//MSK-000110-Start Ajax  
			...
			xhttp.open("GET", "show_teacher2.php?year="+year  + "&month="+month + "&index="+index, true);												
...
function showAttendance(year,month,id){
	...
	var xhttp = new XMLHttpRequest();//MSK-000110-Start Ajax  
    	...
    	xhttp.open("GET", "teacher_attendance_history1.php?year="+year +  "&month="+month +  "&index="+id, true);												
  		xhttp.send();//MSK-000110-End Ajax
