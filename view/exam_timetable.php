                	...
                	<div class="box-header with-border">
                  	...
                  	<div class="box-body">
                    	<div class="form-group col-md-5" id="divGender1">
                        	<label>class</label>
                    		<select name="grade" class="form-control col-md-3" id="grade" >
...
$my_school_row= mysqli_fetch_assoc($my_school_result);
$my_school= $my_school_row['id'];
$sql="SELECT * FROM exam WHERE Id_School = '$my_school'";
$result=mysqli_query($conn,$sql);
if(mysqli_num_rows($result) > 0){
	while($row=mysqli_fetch_assoc($result)){
?> 
...
//MSK-000109
	...
	var xhttp = new XMLHttpRequest();//MSK-000110-Start Ajax  
    	...
    	xhttp.open("GET", "exam_timetable_grade_wise.php?grade="+grade +  "&exam="+exam + "&my_school="+my_school + "&do="+do1 , true);												
...
//MSK-000114	
	...
	var xhttp = new XMLHttpRequest();//MSK-000115-Ajax Start  
    	...
    	xhttp.open("GET", "exam_timetable_insert_form.php?grade="+grade + "&exam="+exam + "&my_school="+my_school , true);												
