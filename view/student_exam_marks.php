...
$sql="SELECT * FROM class WHERE id_school='$Id_School' ";
...
$sql="SELECT * FROM exam WHERE id_school='$Id_School'";
$result=mysqli_query($conn,$sql);
if(mysqli_num_rows($result) > 0){
	while($row=mysqli_fetch_assoc($result)){
?> 
...
<?php }} ?>
                  	...
                  	<div class="box-footer">
                    	...
                    	<button type="button" id="btnSubmit" class="btn btn-primary"  onClick="showStudent(this)">Submit</button>
                  	</div>
            	</div>
        	</div>
    	</div>
...
function showModalAddExam(exam,std_index,grade,Id_School){
