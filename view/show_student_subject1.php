...
<?php } } ?>                            
            			...
            			<div class="panel-footer bg-blue-active">
                    		...
                    		<button type="button" class="btn btn-info " id="btnSubmit2" onClick="editSubject1(this)" style="width:100%;"><span class="glyphicon glyphicon-ok-sign"></span>Submit</button>
             			</div>
      				</div>
         		</div>
            </div>
