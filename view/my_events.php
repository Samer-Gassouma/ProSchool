        	...
        	<div class="col-md-8">
            	<div class="box">
                    <div id="calendar-container">
                        ...
                        <div class="col-md-7" >
                            <select class="form-control col-md-3 " id="cal_month" >
                           ...
                           <button type="button" class="btn btn-info btn-md"  id="btnShow" onClick="ShowEvents1(this)">
                                <i class="fa fa-calendar" aria-hidden="true"></i> Show
                           </button>
                           <input type="hidden" id="my_index" value="<?php echo $my_index; ?>">  
                           <input type="hidden" id="my_type" value="<?php echo $my_type; ?>">                         
                        </div>
                        <div class="col-md-1">
                        	<a href="#" onClick="createEvents('<?php echo $my_index; ?>','<?php echo $my_type; ?>')" class="btn btn-sm  bg-orange-active pull-right " data-id="" data-toggle="modal"><span class="glyphicon glyphicon-plus"></span> Create Event </a>
                        </div>
                        <br><br>
