...
if(isset($_arguments["do"])&& ($_arguments["do"] != "")){
	...
	}else if(($_arguments["do"] == "add_avertissement")){//MSK-000143-add_subject
		$page = "model/add_avertissements.php";
	...
	}elseif(($_arguments["do"] == "add_teacher_subject")){//MSK-000143-add_teacher_subject
		$page = "view/add_teacher_subject.php";
	}elseif(($_arguments["do"] == "add_room")){//MSK-000143-add_teacher_subject
		$page = "model/add_room.php";
	}															
}else{
