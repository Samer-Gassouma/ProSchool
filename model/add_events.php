...
if(isset($_POST["do"])&&($_POST["do"]=="add_events")){
	...
	$sql="INSERT INTO events (title,note,color,category_id,grade_id,create_by,creator_type,start_date_time,end_date_time,year,month,id_school) 
     	  VALUES ( '".$title."','".$note."','".$color."','".$category_id."','".$grade_id."','".$my_index."','".$my_type."','".$start_date_time1."','".$end_date_time1."','".$year."','".$month."','".$id."')";
